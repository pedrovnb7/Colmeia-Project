...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: pesquisar_avaliar_usuarios_co.php");
    exit();
}
...
<body>
    <div class="container">
        <header id="header">
            <div class="menu">
                <a href="pesquisar_avaliar_usuarios_co.php" class="back-home"><i class="bi bi-arrow-left-circle"></i></a>
                <img src="assets/img/logo.png" class="logo" alt="Logo">
            </div>
        </header>
        <div class="content">
            <h1>Avaliar Usuário: <?= htmlspecialchars($usuario['nome']); ?></h1>
            <form action="processar_avaliacao_co.php" method="post">
...
<input type="radio" name="rating" value="1" id="rating1"><label for="rating1">☆</label>
    ...
    <a href="pesquisar_avaliar_usuarios_co.php" class="button">Cancelar</a>
</form>
